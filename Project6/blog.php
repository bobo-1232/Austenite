...
<body>
  ...
  <div class="p-home">
    ...
    <div class="p-header-inner">
      ...
      <a href="post.html" ><button class="button">Share your experience!</button></a>
      ...
      */
      ...
      while($row =  mysqli_fetch_array($result)){
        ...
        $command1 = "SELECT firstname, lastname FROM user WHERE userid = '$userid';";
        $result1 = $db->query($command1);
        $rowx = mysqli_fetch_array($result1);
        echo "<h5>" . $rowx['firstname'] .' '. $rowx['lastname'] . ", ". $row['create_time']. "</h5>";
